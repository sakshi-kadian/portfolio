...
const skills = [
  ...
  { icon: <SiNeo4J />, label: "Neo4J", color: "#008CC1" },
  { icon: <SiHuggingface />, label: "Transformers", color: "#FFD21E" },
  { icon: <SiGraphql />, label: "NetworkX", color: "#E10098" },
  { icon: <SiRedis />, label: "ChromaDB", color: "#DC382D" },
  { icon: <SiDocker />, label: "Docker", color: "#2496ED" },
  { icon: <SiChainlink />, label: "LangChain", color: "#1C3C3C" },
  { icon: <SiMoleculer />, label: "RDKit", color: "#3838B8" },
